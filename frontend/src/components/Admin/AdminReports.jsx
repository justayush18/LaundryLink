...
import { TrendingUp, RefreshCw, Calendar, Award, Star, BarChart2, Users } from 'lucide-react';
...
export default function AdminReports() {
  ...
  const [activeTab, setActiveTab] = useState('REPORTS'); // 'REPORTS' | 'INTELLIGENCE'
  ...
  return (
    <div className="main-content">
      <div style={styles.header}>
        <div>
          ...
          <p style={{ color: 'var(--text-secondary)', margin: 0, fontSize: '0.95rem' }}>
            Fulfillment statistics, rolling revenue metrics, and stakeholder profile analytics.
          </p>
        </div>
        {activeTab === 'REPORTS' && (
          <button 
      ...
      {/* Tabs */}
      <div style={{ display: 'flex', gap: '8px', borderBottom: '2px solid var(--bg-secondary)', marginBottom: '2rem', paddingBottom: '2px' }}>
        <button 
          ...
          style={{
            ...
            fontSize: '0.95rem',
            fontWeight: 800,
            color: activeTab === 'REPORTS' ? 'var(--primary-teal)' : 'var(--text-secondary)',
            borderBottom: activeTab === 'REPORTS' ? '3px solid var(--primary-teal)' : '3px solid transparent',
            padding: '8px 16px',
            cursor: 'pointer',
        ...
        >
          <BarChart2 size={16} color={activeTab === 'REPORTS' ? 'var(--primary-teal)' : 'var(--text-secondary)'} />
        ...
        <button 
          ...
          style={{
            ...
            fontSize: '0.95rem',
            fontWeight: 800,
            color: activeTab === 'INTELLIGENCE' ? 'var(--primary-teal)' : 'var(--text-secondary)',
            borderBottom: activeTab === 'INTELLIGENCE' ? '3px solid var(--primary-teal)' : '3px solid transparent',
            padding: '8px 16px',
            cursor: 'pointer',
            fontFamily: 'Outfit, sans-serif',
            transition: 'all 0.2s ease',
        ...
        >
          <Users size={16} color={activeTab === 'INTELLIGENCE' ? 'var(--primary-teal)' : 'var(--text-secondary)'} />
